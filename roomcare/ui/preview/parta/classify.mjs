...
const NAMED = new Map([
  ...
  ["1a|Map", ["adjudicate", "A chip, a <button> on both sides since the re-lock (65762c95), so it pairs for the first time. Display: the frame's inline-block computes block in the build's flex row (blockified; neither). Spacing: drawn as the chip's own 6px bottom margin, built as the row's 6px gap; nothing rules which (adjudicate)"]],
  ...
  ["1a|Zone", ["adjudicate", "A chip, a <button> on both sides since the re-lock (65762c95), so it pairs for the first time. Display: the frame's inline-block computes block in the build's flex row (blockified; neither). Spacing: drawn as the chip's own 6px bottom margin, built as the row's 6px gap; nothing rules which (adjudicate)"]],
  ...
  ["1b|Wall", ["adjudicate", "A chip, a <button> on both sides since the re-lock (65762c95), so it pairs for the first time. Display: the frame's inline-block computes block in the build's flex row (blockified; neither). Spacing: drawn as the chip's own 6px bottom margin, built as the row's 6px gap; nothing rules which (adjudicate)"]],
  ["1b|Zone", ["adjudicate", "A chip, a <button> on both sides since the re-lock (65762c95), so it pairs for the first time. Display: the frame's inline-block computes block in the build's flex row (blockified; neither). Spacing: drawn as the chip's own 6px bottom margin, built as the row's 6px gap; nothing rules which (adjudicate)"]],
  ...
  ["4|Guest departed", ["adjudicate", "A chip, a <button> on both sides since the re-lock (65762c95), so it pairs for the first time. Display: the frame's inline-block computes block in the build's flex row (blockified; neither). Spacing: drawn as the chip's own 6px bottom margin, built as the row's 6px gap; nothing rules which (adjudicate); the frame draws it chosen (brand border, ink) where nothing is chosen on arrival (neither)"]],
  ...
  ["4c|All", ["adjudicate", "A chip, a <button> on both sides since the re-lock (65762c95), so it pairs for the first time. Display: the frame's inline-block computes block in the build's flex row (blockified; neither). Spacing: drawn as the chip's own 6px bottom margin, built as the row's 6px gap; nothing rules which (adjudicate)"]],
  ...
  ["4c|Sheet", ["adjudicate", "A chip, a <button> on both sides since the re-lock (65762c95), so it pairs for the first time. Display: the frame's inline-block computes block in the build's flex row (blockified; neither). Spacing: drawn as the chip's own 6px bottom margin, built as the row's 6px gap; nothing rules which (adjudicate)"]],
  ...
  ["4c|Zone", ["adjudicate", "A chip, a <button> on both sides since the re-lock (65762c95), so it pairs for the first time. Display: the frame's inline-block computes block in the build's flex row (blockified; neither). Spacing: drawn as the chip's own 6px bottom margin, built as the row's 6px gap; nothing rules which (adjudicate)"]],
  ...
  ["4d|Tap grid", ["adjudicate", "A chip, a <button> on both sides since the re-lock (65762c95), so it pairs for the first time. Display: the frame's inline-block computes block in the build's flex row (blockified; neither). Spacing: drawn as the chip's own 6px bottom margin, built as the row's 6px gap; nothing rules which (adjudicate)"]],
  ["4e|Compact", ["adjudicate", "A chip, a <button> on both sides since the re-lock (65762c95), so it pairs for the first time. Display: the frame's inline-block computes block in the build's flex row (blockified; neither). Spacing: drawn as the chip's own 6px bottom margin, built as the row's 6px gap; nothing rules which (adjudicate)"]],
  ...
  ["7b|Standard", ["adjudicate", "A chip, a <button> on both sides since the re-lock (65762c95), so it pairs for the first time. Display: the frame's inline-block computes block in the build's flex row (blockified; neither). Spacing: drawn as the chip's own 6px bottom margin, built as the row's 6px gap; nothing rules which (adjudicate)"]],
  ...
  ["7e|All", ["adjudicate", "A chip, a <button> on both sides since the re-lock (65762c95), so it pairs for the first time. Display: the frame's inline-block computes block in the build's flex row (blockified; neither). Spacing: drawn as the chip's own 6px bottom margin, built as the row's 6px gap; nothing rules which (adjudicate)"]],
