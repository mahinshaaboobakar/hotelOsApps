...
const NAMED = new Map([
  ...
  ["1a|Map", ["neither", "BUILT for the next cut, 2026-09-19 (the architect accepted it without an owner page): .btn.chip margin 0 6px 6px 0 and no gap on .chips, so the space below a chip row now measures as drawn — board and wall 12, the view switcher 27, the filter row 12, Services 18 (chipgap.mjs); Areas measures 12 against 18, which is its container, not the chip. What remains on this node is the display blockified in a flex row. Was: PROPOSED: the build moves. A chip, a <button> on both sides since the re-lock (65762c95). The owner approved the second set's .chip, margin 0 6px 6px 0 (19f203c5, 'we can go with second'). The build spaces a chip row with the row's 6px gap and drops the 6px below it, and the difference is visible. Measured below the chip row (preview/audit/chipgap.mjs): board and wall 12px drawn, 10 built; the view switcher 27, 24; Setup's chips 18, 10-12. Display blockified in a flex row (neither)."]],
  ...
  ["1a|Zone", ["neither", "BUILT for the next cut, 2026-09-19 (the architect accepted it without an owner page): .btn.chip margin 0 6px 6px 0 and no gap on .chips, so the space below a chip row now measures as drawn — board and wall 12, the view switcher 27, the filter row 12, Services 18 (chipgap.mjs); Areas measures 12 against 18, which is its container, not the chip. What remains on this node is the display blockified in a flex row. Was: PROPOSED: the build moves. A chip, a <button> on both sides since the re-lock (65762c95). The owner approved the second set's .chip, margin 0 6px 6px 0 (19f203c5, 'we can go with second'). The build spaces a chip row with the row's 6px gap and drops the 6px below it, and the difference is visible. Measured below the chip row (preview/audit/chipgap.mjs): board and wall 12px drawn, 10 built; the view switcher 27, 24; Setup's chips 18, 10-12. Display blockified in a flex row (neither)."]],
  ...
  ["1b|Wall", ["neither", "BUILT for the next cut, 2026-09-19 (the architect accepted it without an owner page): .btn.chip margin 0 6px 6px 0 and no gap on .chips, so the space below a chip row now measures as drawn — board and wall 12, the view switcher 27, the filter row 12, Services 18 (chipgap.mjs); Areas measures 12 against 18, which is its container, not the chip. What remains on this node is the display blockified in a flex row. Was: PROPOSED: the build moves. A chip, a <button> on both sides since the re-lock (65762c95). The owner approved the second set's .chip, margin 0 6px 6px 0 (19f203c5, 'we can go with second'). The build spaces a chip row with the row's 6px gap and drops the 6px below it, and the difference is visible. Measured below the chip row (preview/audit/chipgap.mjs): board and wall 12px drawn, 10 built; the view switcher 27, 24; Setup's chips 18, 10-12. Display blockified in a flex row (neither)."]],
  ["1b|Zone", ["neither", "BUILT for the next cut, 2026-09-19 (the architect accepted it without an owner page): .btn.chip margin 0 6px 6px 0 and no gap on .chips, so the space below a chip row now measures as drawn — board and wall 12, the view switcher 27, the filter row 12, Services 18 (chipgap.mjs); Areas measures 12 against 18, which is its container, not the chip. What remains on this node is the display blockified in a flex row. Was: PROPOSED: the build moves. A chip, a <button> on both sides since the re-lock (65762c95). The owner approved the second set's .chip, margin 0 6px 6px 0 (19f203c5, 'we can go with second'). The build spaces a chip row with the row's 6px gap and drops the 6px below it, and the difference is visible. Measured below the chip row (preview/audit/chipgap.mjs): board and wall 12px drawn, 10 built; the view switcher 27, 24; Setup's chips 18, 10-12. Display blockified in a flex row (neither)."]],
  ...
  ["4|Guest departed", ["neither", "The frame draws this chip as the chosen one (class on); the recorded room's stay is another, so the build draws it unchosen — an example, not a rule. BUILT for the next cut, 2026-09-19 (the architect accepted it without an owner page): .btn.chip margin 0 6px 6px 0 and no gap on .chips, so the space below a chip row now measures as drawn — board and wall 12, the view switcher 27, the filter row 12, Services 18 (chipgap.mjs); Areas measures 12 against 18, which is its container, not the chip. What remains on this node is the display blockified in a flex row. Was: PROPOSED: the build moves. A chip, a <button> on both sides since the re-lock (65762c95). The owner approved the second set's .chip, margin 0 6px 6px 0 (19f203c5, 'we can go with second'). The build spaces a chip row with the row's 6px gap and drops the 6px below it, and the difference is visible. Measured below the chip row (preview/audit/chipgap.mjs): board and wall 12px drawn, 10 built; the view switcher 27, 24; Setup's chips 18, 10-12. Display blockified in a flex row (neither). Also: the frame draws it chosen (brand border, ink) where nothing is chosen on arrival (neither)."]],
  ...
  ["4c|All", ["neither", "BUILT for the next cut, 2026-09-19 (the architect accepted it without an owner page): .btn.chip margin 0 6px 6px 0 and no gap on .chips, so the space below a chip row now measures as drawn — board and wall 12, the view switcher 27, the filter row 12, Services 18 (chipgap.mjs); Areas measures 12 against 18, which is its container, not the chip. What remains on this node is the display blockified in a flex row. Was: PROPOSED: the build moves. A chip, a <button> on both sides since the re-lock (65762c95). The owner approved the second set's .chip, margin 0 6px 6px 0 (19f203c5, 'we can go with second'). The build spaces a chip row with the row's 6px gap and drops the 6px below it, and the difference is visible. Measured below the chip row (preview/audit/chipgap.mjs): board and wall 12px drawn, 10 built; the view switcher 27, 24; Setup's chips 18, 10-12. Display blockified in a flex row (neither)."]],
  ...
  ["4c|Sheet", ["neither", "BUILT for the next cut, 2026-09-19 (the architect accepted it without an owner page): .btn.chip margin 0 6px 6px 0 and no gap on .chips, so the space below a chip row now measures as drawn — board and wall 12, the view switcher 27, the filter row 12, Services 18 (chipgap.mjs); Areas measures 12 against 18, which is its container, not the chip. What remains on this node is the display blockified in a flex row. Was: PROPOSED: the build moves. A chip, a <button> on both sides since the re-lock (65762c95). The owner approved the second set's .chip, margin 0 6px 6px 0 (19f203c5, 'we can go with second'). The build spaces a chip row with the row's 6px gap and drops the 6px below it, and the difference is visible. Measured below the chip row (preview/audit/chipgap.mjs): board and wall 12px drawn, 10 built; the view switcher 27, 24; Setup's chips 18, 10-12. Display blockified in a flex row (neither)."]],
  ...
  ["4d|Tap grid", ["neither", "BUILT for the next cut, 2026-09-19 (the architect accepted it without an owner page): .btn.chip margin 0 6px 6px 0 and no gap on .chips, so the space below a chip row now measures as drawn — board and wall 12, the view switcher 27, the filter row 12, Services 18 (chipgap.mjs); Areas measures 12 against 18, which is its container, not the chip. What remains on this node is the display blockified in a flex row. Was: PROPOSED: the build moves. A chip, a <button> on both sides since the re-lock (65762c95). The owner approved the second set's .chip, margin 0 6px 6px 0 (19f203c5, 'we can go with second'). The build spaces a chip row with the row's 6px gap and drops the 6px below it, and the difference is visible. Measured below the chip row (preview/audit/chipgap.mjs): board and wall 12px drawn, 10 built; the view switcher 27, 24; Setup's chips 18, 10-12. Display blockified in a flex row (neither)."]],
  ["4e|Compact", ["neither", "BUILT for the next cut, 2026-09-19 (the architect accepted it without an owner page): .btn.chip margin 0 6px 6px 0 and no gap on .chips, so the space below a chip row now measures as drawn — board and wall 12, the view switcher 27, the filter row 12, Services 18 (chipgap.mjs); Areas measures 12 against 18, which is its container, not the chip. What remains on this node is the display blockified in a flex row. Was: PROPOSED: the build moves. A chip, a <button> on both sides since the re-lock (65762c95). The owner approved the second set's .chip, margin 0 6px 6px 0 (19f203c5, 'we can go with second'). The build spaces a chip row with the row's 6px gap and drops the 6px below it, and the difference is visible. Measured below the chip row (preview/audit/chipgap.mjs): board and wall 12px drawn, 10 built; the view switcher 27, 24; Setup's chips 18, 10-12. Display blockified in a flex row (neither)."]],
  ...
  ["7b|Standard", ["neither", "BUILT for the next cut, 2026-09-19 (the architect accepted it without an owner page): .btn.chip margin 0 6px 6px 0 and no gap on .chips, so the space below a chip row now measures as drawn — board and wall 12, the view switcher 27, the filter row 12, Services 18 (chipgap.mjs); Areas measures 12 against 18, which is its container, not the chip. What remains on this node is the display blockified in a flex row. Was: PROPOSED: the build moves. A chip, a <button> on both sides since the re-lock (65762c95). The owner approved the second set's .chip, margin 0 6px 6px 0 (19f203c5, 'we can go with second'). The build spaces a chip row with the row's 6px gap and drops the 6px below it, and the difference is visible. Measured below the chip row (preview/audit/chipgap.mjs): board and wall 12px drawn, 10 built; the view switcher 27, 24; Setup's chips 18, 10-12. Display blockified in a flex row (neither)."]],
  ...
  ["7e|All", ["neither", "BUILT for the next cut, 2026-09-19 (the architect accepted it without an owner page): .btn.chip margin 0 6px 6px 0 and no gap on .chips, so the space below a chip row now measures as drawn — board and wall 12, the view switcher 27, the filter row 12, Services 18 (chipgap.mjs); Areas measures 12 against 18, which is its container, not the chip. What remains on this node is the display blockified in a flex row. Was: PROPOSED: the build moves. A chip, a <button> on both sides since the re-lock (65762c95). The owner approved the second set's .chip, margin 0 6px 6px 0 (19f203c5, 'we can go with second'). The build spaces a chip row with the row's 6px gap and drops the 6px below it, and the difference is visible. Measured below the chip row (preview/audit/chipgap.mjs): board and wall 12px drawn, 10 built; the view switcher 27, 24; Setup's chips 18, 10-12. Display blockified in a flex row (neither)."]],
