...
export const JUDGED = [
  ...
  { id: "H4", where: "frames", v: "PASS", how: "frames", why: "Closed by 01c, re-locked fff2d96b (owner-approved): every control in a frame is the build's <button> (01: 74 tabs, 72 actions, 8 pager buttons; 02: 42, 37, 4), and the pager rule is tied to its class, not the span. Measured: 0 differing pixels, each whole page as locked against it revised (1400 x 16,600 and 1400 x 9,800). The tiles and chips went first, in 65762c95", before: { v: "FAIL", why: "The frames draw tiles, chips and actions as div and span where the build uses button (ARCH-Q20)" } },
