...
export interface Posting {
  ...
  /**
   * What the capability register says — the worst band this person holds.
   *
   * A band and a count rather than the sentence `"2 expiring"`, which the
   * service used to compose in whatever culture it runs under (NUM-Q1, ADR
   * 0174). The screen writes the words and the digits.
   */
  standing: "expired" | "expiring" | "valid" | "none";

  /** How many certificates are in that band — zero for `none`. */
  certificates: number;
...
export interface People {
  ...
  /**
   * Certificates expiring across the property — counted by the service where
   * the register lives, never from this page's rows.
   */
  expiring: number;
}
...
export const recordedPeople: People = {
  ...
  // The property's, not this page's: three expiring rows are on this page and
  // seventeen people are not, so a screen that counted the page would say 3.
  expiring: 5,
  postings: [
    {
      id: "p-pt", version: 1, who: "Priya Thomas", since: "2023-03-12", postings: 1, departments: ["FO"],
      zone: null, role: "Supervisor", reportsTo: "— department head",
      standing: "valid", certificates: 3, tone: "ok",
    },
    {
      id: "p-am", version: 1, who: "Anjali Menon", since: "2025-01-04", postings: 1, departments: ["FO"],
      zone: null, role: "Receptionist", reportsTo: "Priya Thomas",
      standing: "expiring", certificates: 1, tone: "warn",
    },
    {
      id: "p-vd", version: 1, who: "Vishnu Das", since: "2021-08-19", postings: 1, departments: ["FO"],
      zone: null, role: "Night auditor", reportsTo: "Priya Thomas",
      standing: "valid", certificates: 2, tone: "ok",
    },
    ...
    // blocks nothing — WF-Q16's judgment side.
    {
      ...
      departments: ["KIT", "BQT"], zone: null, role: "Sous chef",
      reportsTo: "Mathew George", standing: "expired", certificates: 1, tone: "bad",
    },
    {
      id: "p-rn", version: 1, who: "Rahul Nair", since: "2024-06-08", postings: 1, departments: ["SEC"],
      zone: null, role: "Security officer", reportsTo: "Thomas Varghese",
      standing: "valid", certificates: 4, tone: "ok",
    },
    {
      id: "p-si", version: 1, who: "Sneha Iyer", since: "2025-11-30", postings: 1, departments: ["FO"],
      zone: null, role: "Receptionist", reportsTo: "Priya Thomas",
      standing: "none", certificates: 0, tone: "neu",
    },
    ...
    // because every other frame in the set draws them.
    {
      ...
      zone: null, role: "Executive chef", reportsTo: "— department head",
      standing: "valid", certificates: 5, tone: "ok",
    },
    {
      id: "p-tv", version: 1, who: "Thomas Varghese", since: "2018-07-14", postings: 1, departments: ["SEC"],
      zone: null, role: "Security manager", reportsTo: "— department head",
      standing: "valid", certificates: 2, tone: "ok",
    },
    {
      id: "p-dm", version: 1, who: "Deepa Menon", since: "2022-09-21", postings: 1, departments: ["HK"],
      zone: null, role: "Housekeeping supervisor", reportsTo: "— department head",
      standing: "valid", certificates: 3, tone: "ok",
    },
    {
      id: "p-ak", version: 1, who: "Arun Kumar", since: "2023-05-05", postings: 1, departments: ["HK"],
      zone: null, role: "Room attendant", reportsTo: "Deepa Menon",
      standing: "expiring", certificates: 1, tone: "warn",
    },
    {
    ...
    },
    {
      ...
      zone: null, role: "Maintenance technician", reportsTo: "Suresh Babu",
      standing: "valid", certificates: 4, tone: "ok",
    },
    {
      id: "p-sb", version: 1, who: "Suresh Babu", since: "2017-11-08", postings: 1, departments: ["ENG"],
      zone: null, role: "Chief engineer", reportsTo: "— department head",
      standing: "valid", certificates: 6, tone: "ok",
    },
    {
      id: "p-fr", version: 1, who: "Fathima Rasheed", since: "2025-02-17", postings: 1, departments: ["FB"],
      zone: null, role: "Server", reportsTo: "Nikhil Varma",
      standing: "none", certificates: 0, tone: "neu",
    },
    {
      id: "p-nv", version: 1, who: "Nikhil Varma", since: "2020-04-29", postings: 1, departments: ["FB"],
      zone: null, role: "Restaurant manager", reportsTo: "— department head",
      standing: "valid", certificates: 3, tone: "ok",
    },
    {
