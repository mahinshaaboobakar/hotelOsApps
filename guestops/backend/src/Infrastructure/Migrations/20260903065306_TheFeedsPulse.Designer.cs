...
namespace HotelOS.GuestOps.Infrastructure.Migrations
{
    ...
    [Migration("20260903065306_TheFeedsPulse")]
    partial class TheFeedsPulse
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelOS.GuestOps.Domain.GuestOpsSettings", b =>
                {
                    b.Property<Guid>("PropertyId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.PrimitiveCollection<List<string>>("AcceptedIdTypes")
                        .IsRequired()
                        .HasColumnType("text[]")
                        .HasColumnName("accepted_id_types");

                    b.Property<string>("CardNumberPrefix")
                        .IsRequired()
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)")
                        .HasColumnName("card_number_prefix");
                    ...
                    b.Property<long>("NextCardNumber")
                        .HasColumnType("bigint")
                        .HasColumnName("next_card_number");

                    b.Property<bool>("PrintOnCheckIn")
                        .HasColumnType("boolean")
                        .HasColumnName("print_on_check_in");

                    b.Property<int>("ReportingAppliesTo")
                        .HasColumnType("integer")
                        .HasColumnName("reporting_applies_to");

                    b.Property<string>("ReportingAuthority")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("reporting_authority");

                    b.Property<int>("ReportingDueHours")
                        .HasColumnType("integer")
                        .HasColumnName("reporting_due_hours");

                    b.Property<bool>("ReportingRequired")
                        .HasColumnType("boolean")
                        .HasColumnName("reporting_required");

                    b.PrimitiveCollection<List<string>>("RequiredForHomeCountry")
                        .IsRequired()
                        .HasColumnType("text[]")
                        .HasColumnName("required_for_home_country");

                    b.PrimitiveCollection<List<string>>("RequiredForVisitors")
                        .IsRequired()
                        .HasColumnType("text[]")
                        .HasColumnName("required_for_visitors");

                    b.Property<bool>("SignatureRequired")
                        .HasColumnType("boolean")
                        .HasColumnName("signature_required");
                    ...
                    b.ToTable("settings", "guestops", t =>
                        {
                            t.HasCheckConstraint("ck_settings__due_hours", "reporting_due_hours > 0");
                        });
                });
            ...
            modelBuilder.Entity("HotelOS.GuestOps.Domain.InboundFeedMark", b =>
                {
                    b.Property<Guid>("PropertyId")
                        .HasColumnType("uuid")
                        .HasColumnName("property_id");
                    ...
                    b.Property<DateTimeOffset>("LastFactAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_fact_at");

                    b.HasKey("PropertyId", "IntegrationId")
                        .HasName("pk_inbound_feed_marks");

                    b.ToTable("inbound_feed_marks", "guestops");
                });
            ...
            modelBuilder.Entity("HotelOS.GuestOps.Domain.Registration", b =>
                {
                    b.HasOne("HotelOS.GuestOps.Domain.RoomStay", "Stay")
                        .WithOne()
                        .HasForeignKey("HotelOS.GuestOps.Domain.Registration", "StayId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_registrations_stays_stay_id");
            ...
            modelBuilder.Entity("HotelOS.GuestOps.Domain.StayReporting", b =>
                {
                    b.HasOne("HotelOS.GuestOps.Domain.RoomStay", "Stay")
                        .WithOne()
                        .HasForeignKey("HotelOS.GuestOps.Domain.StayReporting", "StayId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_stay_reporting_room_stays_stay_id");
