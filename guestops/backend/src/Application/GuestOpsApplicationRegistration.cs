...
public static class GuestOpsApplicationRegistration
{
    ...
    public static IServiceCollection AddGuestOpsApplication(this IServiceCollection services)
    {
        ...
        services.AddScoped<Module.SetupView>();
        ...
        services.AddScoped<Module.FreeRoomsView>();
        services.AddScoped<Module.CancelPlanView>();
        services.AddScoped<Module.WalkInCommand>();
        services.AddScoped<Module.BookCommand>();
        services.AddScoped<Module.RequestCommand>();
        services.AddScoped<Module.RegistrationView>();
        ...
        services.AddScoped<Module.CheckOutCommand>();
